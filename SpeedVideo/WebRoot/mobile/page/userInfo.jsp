			...
			<div id="main-body">
				...
				<div id="content">
					<table>
						<tr>
							<td colspan="2">
								<img src="${pageContext.request.contextPath}/images/${user.photo}" alt="" width="180" height="120" />
							</td>
						</tr>
						<c:if test="${sessionScope.user.id==user.id}">
						<tr>
						<td>
						<a href="${pageContext.request.contextPath}/mobile/page/uploadImage.jsp">更换头像</a></td>
						<td>
						<a href="${pageContext.request.contextPath}/mobile/page/editUser.jsp">修改资料</a></td>
						</tr>
						</c:if>
						<tr>
							<td>
